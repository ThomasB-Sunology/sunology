...
export const buttonVariants = cva(
    "inline-flex gap-2.5 items-center font-inter font-semibold rounded-full transition-all ease-in-out",
    {
        variants: {
            intent: {
                primary: "bg-electric-blue text-white hover:bg-mid-blue hover:shadow-[0px_2px_6px_0px_#A4A4E4] focus:bg-deep-blue focus:shadow-[0px_2px_6px_0px_#A4A4E4]",
                secondary: "bg-energy-yellow text-background-black hover:bg-hover-yellow focus:bg-deep-yellow",
